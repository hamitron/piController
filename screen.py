...
display = Adafruit_SSD1306.SSD1306_128_64(rst=None, gpio=GPIO, i2c_address=oledAddress)
font = ImageFont.truetype('/usr/share/fonts/truetype/droid/DroidSansFallbackFull.ttf', 18)
...
def read(address):
    with SMBusWrapper(1) as bus:
        b = bus.read_byte_data(boardAddress, address)
        return b
